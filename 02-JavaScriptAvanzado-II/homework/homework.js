...
function delimitador(d){
return d;
};
let textoAsteriscos=crearCadena.bind(delimitador("*"),delimitador("*"),delimitador("*"));
let textoGuiones=crearCadena.bind(delimitador("-"),delimitador("-"),delimitador("-"));
let textoUnderscore=crearCadena.bind(delimitador("_"),delimitador("_"),delimitador("_"));
